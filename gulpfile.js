...
const 
  ...
  CSS_output_1 = "basic/public_html/media/build/css/"

  JS_name_1 = "JS_1",  
  JS_input_1 = "src/js/index/**/*.js", 
  JS_output_1 = "basic/public_html/media/build/js/";

  JS_name_2 = "JS_2",  
  JS_input_2 = "src/js/login/**/*.js", 
  JS_output_2 = "basic/public_html/media/build/js/";

  JS_name_3 = "JS_3",  
  JS_input_3 = "src/js/admin_panel/**/*.js", 
  JS_output_3 = "basic/public_html/media/build/js/";
...
// JS - 2
gulp.task(JS_name_2, function() {
  return gulp.src(JS_input_2)
    //.pipe(gulp_watch(JS_input_1, { verbose: true, "ignoreInitial": false}, function(f){
      //console.clear();
      //console.log(f.path);
      //console.log('=============== [Compilide started!] ===============');
    ...
    .pipe(gulp.dest(JS_output_2))
    .pipe(livereload());
});


// JS - 3
gulp.task(JS_name_3, function() {
  return gulp.src(JS_input_3)
    //.pipe(gulp_watch(JS_input_1, { verbose: true, "ignoreInitial": false}, function(f){
      //console.clear();
      //console.log(f.path);
      //console.log('=============== [Compilide started!] ===============');
    ...
    .pipe(plumber()) 
    .pipe(minifyJS())
    .pipe(concat('admin_panel-min.js'))
    .pipe(gulp.dest(JS_output_3))
    .pipe(livereload());
});
...
gulp.task('watch', function () {
    ...
    gulp.watch(JS_input_1, gulp.series(JS_name_1));

    gulp.watch(JS_input_2, gulp.series(JS_name_2));

    gulp.watch(JS_input_3, gulp.series(JS_name_3));

    gulp.watch(SASS_input_1, gulp.series(SASS_name_1, CSS_name_1));
